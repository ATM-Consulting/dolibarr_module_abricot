...
Calendar._TT["SEL_DATE"] = "Sélectionnez date";
Calendar._TT["DRAG_TO_MOVE"] = "Laissez le clic enfoncé pour dépacer";
Calendar._TT["PART_TODAY"] = " (aujourd'hui)";

// the following is to inform that "%s" is to be the first day of week
// %s will be replaced with the day name.
Calendar._TT["DAY_FIRST"] = "Mettre le jour %s en premier";
